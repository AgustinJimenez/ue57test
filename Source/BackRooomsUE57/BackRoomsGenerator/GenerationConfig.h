...
struct FBackroomGenerationConfig
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Safety", meta = (ClampMin = "5.0", ClampMax = "120.0", Units = "s"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dimensions", meta = (ClampMin = "1.0", ClampMax = "10.0", Units = "m"))
    float StandardRoomHeight = 3.0f;
    
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dimensions", meta = (ClampMin = "0.1", ClampMax = "1.0", Units = "m"))
    float WallThickness = 0.2f; // 20cm walls
    
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dimensions", meta = (ClampMin = "0.01", ClampMax = "0.5", Units = "m"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Connections", meta = (ClampMin = "0.5", ClampMax = "1.2", Units = "m"))
    float StandardDoorwayWidth = 0.8f;
    
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Connections", meta = (ClampMin = "1.8", ClampMax = "2.5", Units = "m"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Room Sizes", meta = (ClampMin = "2.0", ClampMax = "8.0", Units = "m"))
